...
class UcrmHandler extends UcrmApi {
   ...
   *
   */
  public function setStripeClientId($client_id, $customer_id) {
    $content = array(
      "userIdent" => $customer_id,
    );
    $endpoint = "/clients/{$client_id}";

    $response = $this->guzzle('PATCH', $endpoint, $content);
  ...
  public function createInvoice($label, $price, $client_id, $note='') {
    $content = array(
      ...
      'adminNotes' => 'Generated by UCRM Stripe api payments plugin'
    );

    $response = $this->guzzle('POST', "/clients/{$client_id}/invoices", $content);
  ...
  public function createPayment($charge_id, $charge_amount, $invoice_id, $client_id, $note='') {
    ...
    $response = $this->guzzle('POST', '/payments', $content);
  ...
  public function createServicePlan($product, $plan) {
    ...
    $response = $this->guzzle('POST', '/service-plans', $content);
   ...
   *
   */
  public function createService($service, $client_id) {
    ...
    $response = $this->guzzle('POST', "/clients/{$client_id}/services", $service);
